...
% Optional: charts (template)
\usepackage{pgfplots}
\pgfplotsset{compat=1.18}

% -----------------------------
% Figure placeholder macro (compiles without external image files)
% -----------------------------
\newcommand{\placeholderfigure}[3]{
\begin{figure}[t]
  \centering
  \fbox{
    \parbox[c][2.0in][c]{0.95\linewidth}{
      \centering
      \textbf{#1}\\
      \vspace{0.25em}
      {\small #2}
...
% Metadata
% -----------------------------
\title{High-Dimensional Nearest-Neighbor Search: Exact Indexing, Approximate Methods, and System-Level Tradeoffs}
...
\begin{figure}[t]
    \centering
    \includegraphics[width=\linewidth]{temporal_report_figs/figures/recall_by_workload.png}
...
\begin{figure}[t]
    \centering
    \includegraphics[width=\linewidth]{temporal_report_figs/figures/latency_by_workload.png}
...
\begin{figure}[t]
    \centering
    \includegraphics[width=\linewidth]{temporal_report_figs/figures/estimator_error.png}
...
\begin{figure}[t]
    \centering
    \includegraphics[width=\linewidth]{temporal_report_figs/figures/planner_quality.png}
...
\newblock \emph{arXiv:1806.09823}.

\bibitem{bentley1975}
Jon Louis Bentley.
\newblock 1975.
\newblock Multidimensional Binary Search Trees Used for Associative Searching.
\newblock \emph{Communications of the ACM} 18, 9, 509--517.

\bibitem{beygelzimer2006}
Alina Beygelzimer, Sham Kakade, and John Langford.
\newblock 2006.
\newblock Cover Trees for Nearest Neighbor.
\newblock In \emph{Proceedings of the 23rd International Conference on Machine Learning}. 97--104.
...
\newblock \emph{Proceedings of the VLDB Endowment} 12, 5, 461--474.

\bibitem{gionis1999}
Aristides Gionis, Piotr Indyk, and Rajeev Motwani.
\newblock 1999.
\newblock Similarity Search in High Dimensions via Hashing.
\newblock In \emph{Proceedings of the 25th International Conference on Very Large Data Bases}. 518--529.

\bibitem{guttman1984}
Antonin Guttman.
\newblock 1984.
\newblock R-Trees: A Dynamic Index Structure for Spatial Searching.
\newblock In \emph{Proceedings of the 1984 ACM SIGMOD International Conference on Management of Data}. 47--57.

\bibitem{indyk1998}
Piotr Indyk and Rajeev Motwani.
\newblock 1998.
\newblock Approximate Nearest Neighbors: Towards Removing the Curse of Dimensionality.
\newblock In \emph{Proceedings of the 30th Annual ACM Symposium on Theory of Computing}. 604--613.
...
\newblock \emph{IEEE Transactions on Pattern Analysis and Machine Intelligence} 42, 4, 824--836.

\bibitem{muja2014}
Marius Muja and David G. Lowe.
\newblock 2014.
\newblock Scalable Nearest Neighbor Algorithms for High Dimensional Data.
\newblock \emph{IEEE Transactions on Pattern Analysis and Machine Intelligence} 36, 11, 2227--2240.
